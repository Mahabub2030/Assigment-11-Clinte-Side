...
//   return (
//     <div className="navbar bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 mb-4 rounded-xl w-full p-4">
//       <div className="navbar-start">
//         <div className="dropdown">
//           <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
//             <svg
...
//           <ul
//             tabIndex={0}
//             className="menu menu-sm dropdown-content bg-base-100 shadow-xl mt-3 w-52 p-2"
//           >
//             <li>
//               <NavLink to="/" className="text-lg">Home</NavLink>
//             </li>
//             <li>
//               <NavLink to="/AllBooks" className="text-lg">All Books</NavLink>
//             </li>
//             <li>
//               <NavLink to="/AddBooks" className="text-lg">Add Books</NavLink>
//             </li>
//             <li>
//               <NavLink to="/BorrowedBooks" className="text-lg">Borrowed Books</NavLink>
//             </li>
//           </ul>
//         </div>
//         <a href="/" className="btn btn-ghost text-xl">
...
//         <ul className="menu menu-horizontal px-1">
//           <li>
//             <NavLink to="/" className="text-lg text-white hover:text-blue-300">Home</NavLink>
//           </li>
//           <li>
//             <NavLink to="/AllBooks" className="text-lg text-white hover:text-blue-300">All Books</NavLink>
//           </li>
//           <li>
//             <NavLink to="/AddBooks" className="text-lg text-white hover:text-blue-300">Add Books</NavLink>
//           </li>
//           <li>
//             <NavLink to="/BorrowedBooks" className="text-lg text-white hover:text-blue-300">Borrowed Books</NavLink>
//           </li>
//         </ul>
//       </div>
//       <div className="navbar-end">
  ...
  return (
    <div className="navbar bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 mb-4 rounded-xl w-full p-4">
      ...
      <button
        ...
        className="btn ml-4 bg-gradient-to-r from-gray-700 to-gray-900 text-white"
      >
